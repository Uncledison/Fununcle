...
export const BentoGrid: React.FC = () => {
    ...
    const handleComingSoonClick = () => {
        ...
        const [currentEmojis, setCurrentEmojis] = useState<string[]>(EMOJI_THEMES[0]);
        ...
        const handleComingSoonClick = () => {
            ...
            setCurrentEmojis(EMOJI_THEMES[randomEmojiIndex]);
        ...
        // Derived state for message only (Emojis are now in state)
        ...
        return (
            <div className="relative z-10 w-full min-h-screen px-4 pb-20 pt-10">
                <ComingSoonEffect
                    key={clickCount} // Force re-mount on every click to restart animation/timer
